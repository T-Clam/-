    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <table class="table table-hover">
                <tr>
                    <td colspan="5">
                        <form action="layout/1" class="form-inline" role="form" method="post">
                            <div class="form-group">
                                <label class="sr-only" for="name">名称</label>
                                <input type="text" name="name" class="form-control" placeholder="请输入类型">
                            </div>
                ...
                if(!empty($type)){
                    foreach ($type as $row){
                        ...
                        echo "<td>".$row->id."</td>";
                        echo "<td>".$row->type."</td>";
                        echo "<td><a href=/admin/layout/2/".$row->id.">删除</a></td>";
                        echo "</tr>";
                    }
                }
                else
