...
<head>
    ...
    body,p{margin:0px; padding:0px; font-size:14px; color:#333; font-family:Arial, Helvetica, sans-serif;}
        ...
        #ct span{color: #d4d4d4; margin-right:10px;}
        .c2{color: #dbdbdb;}
            .c3{background-color:#DBE9EC; padding:5px;}
        .qp{position:absolute; font-size:12px; color: #fbfbfb; top:5px; right:130px; text-decoration:none; color:#069;}
...
<div class="rin">
    ...
    <span><img src="http://www.yxsss.com/ui/sk/e.png" title="上传图片"><form><input type="file" title="上传图片" id="upimg"></form></span>
    <p><input id="nrong"></p>
</div>
